...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${requestScope.stageList}" var="stage">
			...
			<c:if test="${requestScope.transaction.orderNo > stage.orderNo}">
				<span class="glyphicon glyphicon-ok-circle mystage" data-toggle="popover" data-placement="bottom" data-content="资质审查" style="color: #90F790;"></span>
				-----------
			</c:if>
			<c:if test="${requestScope.transaction.orderNo < stage.orderNo}">
				<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="${stage.}"></span>
				-----------
			</c:if>
		</c:forEach>
