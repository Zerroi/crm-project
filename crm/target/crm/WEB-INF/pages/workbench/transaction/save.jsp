				...
				$.ajax({
					...
					success : function (data) {
						...
						$.each(data, function (index, obj) {
							htlmStr += "<tr>"
							htlmStr += "<td><input type=\"radio\" value=\""+obj.id+"\" activityName=\""+obj.name+"\" name=\"activity\"/></td>"
							htlmStr += "<td>"+obj.name+"</td>"
							htlmStr += "<td>"+obj.startDate+"</td>"
							htlmStr += "<td>"+obj.endDate+"</td>"
							htlmStr += "<td>"+obj.owner+"</td>"
							htlmStr += "</tr>"
						});
						$("#activityTbody").html(htlmStr);
					}
				});
			});
			...
			$("#contactsSearch").keyup(function () {
				...
				$.ajax({
					...
					success : function (data) {
						...
						$.each(data, function (index, obj) {
							htmlStr += "<tr>"
							htmlStr += "<td><input type=\"radio\" value=\""+obj.id+"\" fullname=\""+obj.fullname+"\" name=\"activity\"/></td>"
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="activitySearch" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" value="" id="create-accountName" placeholder="支持自动补全，输入客户不存在则新建">
			</div>
